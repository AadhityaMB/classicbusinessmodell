...
public class OfficeController {
    ...
    @PostMapping
    public ApiResponse<OfficeResponseDTO> createOffice(
            @Valid @RequestBody OfficeRequestDTO dto) {
    ...
    @Operation(
            summary = "Get office by code",
            description = "Retrieves a single office by its office code"
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ApiResponse<OfficeResponseDTO> getOffice(
            ...
            // Office code from path variable
    ...
    // Get all employees belonging to an office
    @Operation(
            summary = "Get employees by office",
            description = "Retrieves all employees belonging to the specified office"
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "404",
                    description = "Office not found or no employees in office"
            )
    })
